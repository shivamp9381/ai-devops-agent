...
public class ProjectContext {
    ...
    public boolean isHasPomXml() { return hasPomXml; }
    public void setHasPomXml(boolean hasPomXml) { this.hasPomXml = hasPomXml; }

    public boolean isHasRequirementsTxt() { return hasRequirementsTxt; }
    public void setHasRequirementsTxt(boolean hasRequirementsTxt) { this.hasRequirementsTxt = hasRequirementsTxt; }

    public boolean isHasGradleBuild() { return hasGradleBuild; }
    public void setHasGradleBuild(boolean hasGradleBuild) { this.hasGradleBuild = hasGradleBuild; }

    public boolean isHasGoMod() { return hasGoMod; }
    public void setHasGoMod(boolean hasGoMod) { this.hasGoMod = hasGoMod; }

    public String getDetectedPort() { return detectedPort; }
    public void setDetectedPort(String detectedPort) { this.detectedPort = detectedPort; }
